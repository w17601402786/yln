jQuery(function () {
    ...
    n = WebUploader.create({
        ...
        paste: document.body,
        accept: {title: "Images", extensions: "gif,html,css,js,c,cpp,py,jpg,jpeg,json,sql,bmp,png,pdf,doc,ppt,pptx,xls,xlsx,docx,rar,zip,7z,tar.gz,war,jar,md,txt,chm,pdr,azw,prc,mbp,tan,tpz,epub,mobi,rp", mimeTypes: ".pdf,.doc,.json,.md,.ppt,.pptx,.xls,.xlsx,.docx,.rar,.zip,.7z,.tar.gz,.war,.jar,.txt,.chm,.pdr,.html,.css,.js,.azw,.prc,.mbp,.tan,.tpz,.epub,.mobi,.rp,.c,.sql,.cpp,.py"},
